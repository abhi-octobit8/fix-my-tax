...
namespace PostalBag.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly PostalBagDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = PostalBagConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(PostalBagDbContext context)
        {
            _context = context;
        }
