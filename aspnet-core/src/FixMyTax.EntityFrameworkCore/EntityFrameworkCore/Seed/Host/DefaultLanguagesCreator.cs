...
namespace FixMyTax.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly FixMyTaxDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = FixMyTaxConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FixMyTaxDbContext context)
        {
            _context = context;
        }
