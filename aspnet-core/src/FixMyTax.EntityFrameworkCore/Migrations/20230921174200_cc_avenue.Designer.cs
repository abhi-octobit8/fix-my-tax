...
namespace FixMyTax.Migrations
{
    ...
    [Migration("20230921174200_cc_avenue")]
    partial class cc_avenue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FixMyTax.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixMyTax.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.CategoryProofFiles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("MeetingInvite")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.RequestTicket", b =>
                {
                    ...
                    b.Property<int>("AssignmentByUserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.Slot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.TicketResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FixMyTax.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FixMyTax.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("FixMyTax.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("FixMyTax.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("FixMyTax.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.Attachment", b =>
                {
                    b.HasOne("FixMyTax.FixMyTaxModels.RequestTicket", null)
                        .WithMany("Attachments")
                        .HasForeignKey("RequestTicketId");

                    b.HasOne("FixMyTax.FixMyTaxModels.TicketResponse", null)
                        .WithMany("Attachments")
            ...
            modelBuilder.Entity("FixMyTax.FixMyTaxModels.TicketResponse", b =>
                {
                    b.HasOne("FixMyTax.FixMyTaxModels.RequestTicket", "Ticket")
                        .WithMany()
                        .HasForeignKey("RequestTicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
