...
{
    public abstract class FixMyTaxWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FixMyTaxWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FixMyTaxWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FixMyTaxDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FixMyTaxDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FixMyTaxDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FixMyTaxDbContext, Task<T>> func)
        {
            T result;
