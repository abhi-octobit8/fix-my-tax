...
{
    public abstract class PostalBagWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PostalBagWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PostalBagWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PostalBagDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PostalBagDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PostalBagDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PostalBagDbContext, Task<T>> func)
        {
            T result;
