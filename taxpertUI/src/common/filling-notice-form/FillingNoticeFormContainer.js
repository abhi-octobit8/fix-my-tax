...
import FillingNoticeForm from "./FillingNoticeForm";

const FillingNoticeFormContainer = (props) => {
  ...
  return <FillingNoticeForm onFinish={onFinish} />;
};

export default FillingNoticeFormContainer;
