...
class User extends AppComponentBase<IUserProps, IUserState> {
  ...
  public render() {
    ...
    return (
      <Card>
         <ListHeader leftContent={<h2>{L('Users')}</h2>}
         rightContent={<Button type="primary" shape="circle" icon={<PlusOutlined />} onClick={() => this.createOrUpdateModalOpen({ id: 0 })} />}></ListHeader>
        {/* <Row>
          <Col
            xs={{ span: 4, offset: 0 }}
            sm={{ span: 4, offset: 0 }}
