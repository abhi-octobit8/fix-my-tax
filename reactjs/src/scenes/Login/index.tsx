...
// import AbpLogo3 from '../../images/emblam.png';
import AbpLogo3 from '../../images/Emblem_of_India.svg';
        ...
        <Row className={'logo-container'}>
          <Col span={6}>
            <div style={{ textAlign: 'center' }}>
              <Avatar className={'logo-img'} shape="square" src={AbpLogo2} />
            </div>
          </Col>
          <Col span={8} offset={2}>
            <div className={'header-content'}>
              <span>{L('RFID Bag Tracking Facility for India Post')}</span>
            </div>
          </Col>
          <Col span={6} offset={2}>
            <div style={{ textAlign: 'center' }}>
