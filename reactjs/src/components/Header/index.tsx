...
import profilePicture from '../../images/user1.png';
import indiaPostSecondLogo from '../../images/india-post-second-logo.png';
    ...
    return (
      <Row className={'header-container'}>
        ...
        <Col style={{ padding: '0px 15px 0px 15px', textAlign: 'right' }} span={12}>
          <Avatar shape="square" style={{ height: 59, width: 109 }} src={indiaPostSecondLogo} />
          {/* <LanguageSelect /> {'   '} */}
